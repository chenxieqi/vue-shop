    ...
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <p class="item-info">っっx<br/>xsx</p>
          <div class="delivery">東京倉庫</div>
          <div class="item-price">＄{{product.price}}</div>
          <div class="line"></div>
          <div class="item-addr">
            <i class="icon-loc"></i>
            <div class="addr">東京</div>
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl">{{product.name}} {{version==1?'6GB+64GB':'4GB+64GB'}} ダークブラウン</div>
              <div class="fr">＄{{product.price}}</div>
            </div>
            <div class="phone-total">合計：＄{{product.price}}</div>
          </div>
          <div class="btn-group">
            <a href="javascript:;" class="btn btn-huge fl" @click="addCart">購入</a>
          </div>
        </div>
      </div>
    </div>
