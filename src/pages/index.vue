      ...
      <div class="swiper-box">
        <div class="nav-menu">
          <ul class="menu-wrapper">
            ...
            <li class="menu-item">
              <a href="javascript:;">仮４</a>
            </li>
            <li class="menu-item">
              <a href="javascript:;">仮５</a>
            </li>
            <li class="menu-item">
              <a href="javascript:;">仮６</a>
            </li>
            <li class="menu-item">
              <a href="javascript:;">仮７</a>
            </li>
          </ul>
        </div>
          ...
          .list{
            ...
            .item{
              ...
              span{
                ...
                margin-top: 2px;
                &.new{
                  background-color: rgb(77, 202, 83);
                }
                &.hot{
